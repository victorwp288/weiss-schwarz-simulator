...
OBS_LEN: int
OBS_ENCODING_VERSION: int
ACTION_ENCODING_VERSION: int
ACTION_SPACE_SIZE: int
ACTION_META_WIDTH: int
ACTION_META_UNUSED: int
REWARD_COMPONENT_WIDTH: int
LEGAL_ACTION_CONTEXT_V1_WIDTH: int
LEGAL_ACTION_CONTEXT_UNUSED: int
SPEC_HASH: int
POLICY_VERSION: int
PASS_ACTION_ID: int
ACTOR_NONE: int
...
class BatchOutMinimalI16LegalIdsNoMeta:
    obs: np.ndarray
    legal_ids: np.ndarray
    legal_offsets: np.ndarray
    rewards: np.ndarray
...
class EnvPool:
    ...
    def reset_into_i16_legal_ids_nometa(self, out: BatchOutMinimalI16LegalIdsNoMeta) -> None: ...
    ...
    def reset_indices_into_i16_legal_ids_nometa(
        self, indices: Sequence[int], out: BatchOutMinimalI16LegalIdsNoMeta
    ) -> None: ...
    ...
    def reset_done_into_i16_legal_ids_nometa(
        self, done_mask: np.ndarray, out: BatchOutMinimalI16LegalIdsNoMeta
    ) -> None: ...
    ...
    def reset_indices_with_episode_seeds_into_i16_legal_ids_nometa(
        self,
        indices: Sequence[int],
        episode_seeds: Sequence[int],
        out: BatchOutMinimalI16LegalIdsNoMeta,
    ) -> None: ...
    ...
    def step_into_i16_legal_ids_nometa(
        self, actions: np.ndarray, out: BatchOutMinimalI16LegalIdsNoMeta
    ) -> None: ...
    ...
    def step_first_legal_into(self, actions: np.ndarray, out: BatchOutMinimal) -> None: ...
    def step_first_legal_into_i16(self, actions: np.ndarray, out: BatchOutMinimalI16) -> None: ...
    def step_first_legal_into_i16_legal_ids(
        self, actions: np.ndarray, out: BatchOutMinimalI16LegalIds
    ) -> None: ...
    def step_first_legal_into_i16_legal_ids_nometa(
        self, actions: np.ndarray, out: BatchOutMinimalI16LegalIdsNoMeta
    ) -> None: ...
    def step_first_legal_into_nomask(
        self, actions: np.ndarray, out: BatchOutMinimalNoMask
    ) -> None: ...
    def step_sample_legal_action_ids_uniform_into(
        self, seeds: np.ndarray, actions: np.ndarray, out: BatchOutMinimal
    ) -> None: ...
    def step_sample_legal_action_ids_uniform_into_i16(
        self, seeds: np.ndarray, actions: np.ndarray, out: BatchOutMinimalI16
    ) -> None: ...
    def step_sample_legal_action_ids_uniform_into_i16_legal_ids(
        self, seeds: np.ndarray, actions: np.ndarray, out: BatchOutMinimalI16LegalIds
    ) -> None: ...
    def step_sample_legal_action_ids_uniform_into_i16_legal_ids_nometa(
        self, seeds: np.ndarray, actions: np.ndarray, out: BatchOutMinimalI16LegalIdsNoMeta
    ) -> None: ...
    def step_sample_legal_action_ids_uniform_into_nomask(
        self, seeds: np.ndarray, actions: np.ndarray, out: BatchOutMinimalNoMask
    ) -> None: ...
    def legal_action_ids_into(self, ids: np.ndarray, offsets: np.ndarray) -> int: ...
    def legal_action_meta_into(self, meta: np.ndarray) -> int: ...
    def legal_action_context_v1_into(self, context: np.ndarray) -> int: ...
    def select_actions_from_logits_into(self, logits: np.ndarray, actions: np.ndarray) -> None: ...
    def sample_actions_from_logits_into(
        self, logits: np.ndarray, seeds: np.ndarray, actions: np.ndarray
    ) -> None: ...
    ...
    def step_select_from_logits_into_i16_legal_ids_nometa(
        self, logits: np.ndarray, actions: np.ndarray, out: BatchOutMinimalI16LegalIdsNoMeta
    ) -> None: ...
    ...
    def step_sample_from_logits_into_i16_legal_ids_nometa(
        self,
        logits: np.ndarray,
        seeds: np.ndarray,
        actions: np.ndarray,
    ...
    def step_sample_from_logits_with_logp_into_i16_legal_ids_nometa(
        self,
        logits: np.ndarray,
        seeds: np.ndarray,
        actions: np.ndarray,
    ...
    def rollout_heuristic_public_into_i16_legal_ids(
        self, steps: int, out: BatchOutTrajectoryI16LegalIds, profile_name: str = ...
    ) -> None: ...
    ...
    def human_decision_view_json(
        self, env_index: int = ..., perspective_seat: int | None = ...
    ) -> str: ...
    ...
    def choose_heuristic_public_actions_into(
        self, env_indices: np.ndarray, actions: np.ndarray
    ) -> None: ...
    def choose_heuristic_public_profile_actions_into(
        self, env_indices: np.ndarray, actions: np.ndarray, profile_name: str
    ) -> None: ...
    def sample_legal_action_ids_uniform_into(
        self, seeds: np.ndarray, actions: np.ndarray
    ) -> None: ...
