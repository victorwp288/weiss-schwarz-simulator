...
use crate::events::{
    ChoiceOptionSummary, ChoiceSkipReason, ModifierRemoveReason, RevealAudience, RevealReason,
    TriggerCancelReason, Zone,
};
use crate::legal::ActionDesc;
use crate::state::{
    ChoiceOptionRef, ChoiceReason, DamageModifierKind, DamageType, ModifierDuration, ModifierKind,
    StackItem, TimingWindow, TriggerEffect,
};
...
pub enum ReplayEvent {
    ...
    AttackType {
        player: u8,
        attacker_slot: u8,
        attack_type: crate::state::AttackType,
    },
    Counter {
        player: u8,
        card: CardId,
