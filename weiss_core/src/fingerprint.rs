...
impl CanonicalCurriculumConfig {
    fn from_curriculum(curriculum: &CurriculumConfig) -> Self {
        ...
        Self {
            ...
            enable_legacy_cost_order: curriculum.enable_legacy_cost_order,
            enable_legacy_shot_damage_step_only: curriculum.enable_legacy_shot_damage_step_only,
...
struct CanonicalTurnState {
    ...
    rule_overrides: Vec<crate::effects::RuleOverrideKind>,
    phase_step: u8,
...
impl CanonicalTurnState {
    fn from_turn(turn: &TurnState) -> Self {
        Self {
            ...
            main_move_used: turn.main_move_used,
            ...
            rule_overrides: turn.rule_overrides.clone(),
